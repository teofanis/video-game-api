...
@section('content')
    <div class="container mx-auto px-4">
        <div class="game-details border-b border-gray-800 pb-12 flex flex-col lg:flex-row">
            <div class="flex-none">
                <img src="https://i.redd.it/9bx4tzvxr5w31.png" alt="cover" width="270" height="338">
            </div>
            <div class="lg:ml-12 lg:mr-64">
                <h2 class="font-semibold text-4xl leading-tight mt-1">World of Warcraft Shadowlands</h2>
                <div class="text-gray-400">
                    <span>MMORPG, Online</span>
                    &middot;
                ...
                <p class="mt-12">
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Consequatur cupiditate deleniti dignissimos dolores ea eveniet incidunt iusto, molestiae odit provident quaerat recusandae, similique, soluta sunt voluptas. Consequuntur quo recusandae voluptates? Lorem ipsum dolor sit amet, consectetur adipisicing elit. Cum error excepturi iste natus officia omnis quas voluptates! Corporis culpa expedita placeat sapiente vel. Delectus minus odit quis quod soluta temporibus.
                </p>
                ...
                <div class="mt-12">
                    <button class="flex bg-blue-500 text-white font-semibold px-4 py-4 hover:bg-blue-600 rounded transition ease-in-out duration-150">
                        ...
                        <span class="ml-2"></span>Play Trailer
                    </button>
                </div>
        ...
        <div class="images-container border-b border-gray-800 pb-12 mt-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 mt-8">
                <div>
                    <a href="#">
                        <img src="https://cdn.vox-cdn.com/thumbor/y53114HukbMGYpk93Gf1iz82VBg=/0x0:2521x1048/1200x800/filters:focal(1060x323:1462x725)/cdn.vox-cdn.com/uploads/chorus_image/image/65609571/883012.0.jpg" alt="Game_screenshots" class="hover:opacity-75 transition ease-in-out duration-150">
                    </a>
                </div>
                <div>
                    <a href="#">
